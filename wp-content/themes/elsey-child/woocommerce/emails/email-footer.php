...
<!--added 18July06-->
<tr class="newfooter">
	<td style="text-align: 'left'; vertical-align:middle; border-top: solid 1px <?php echo $bordercolor;?>; word-wrap:break-word;">
            ...
            <div class="footer" style="font-family: <?php echo $bodyFont;?>; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; width: 100%; clear: both; color: #666; margin: 0; padding: 0;">
                <table width="100%" style="font-family: <?php echo $bodyFont;?>; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; margin: 0; padding: 0;">
                   ...
                   <?php
                    ...
                    <td class="alignright quarter" style="font-family: <?php echo $bodyFont;?>; box-sizing: border-box; font-size: <?php echo $bodyfontsize;?>; vertical-align: middle; text-align: <?php echo is_rtl() ? 'left' : 'right' ?>; width: 25%; margin: 0; padding: 10px 0;" align="right" valign="middle" width="25%">
