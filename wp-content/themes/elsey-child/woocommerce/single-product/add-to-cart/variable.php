...
>
    ...
    <?php else : ?>
        <ul class="pdp__attribute--list pdp__attribute--group variations zoo-cw-variations">
            <?php
            $zoo_cw_attr_class = '';
            $zoo_cw_tr_class = '';
            ...
            foreach ($attributes as $attribute_name => $options) :
                ...
                ?>
                <li class="<?php echo esc_attr($zoo_cw_tr_class) ?> pdp__attribute variations__attribute">
                    <div class="label">
                        <label>
                    ...
                    <div class="value zoo-cw-group-attribute <?php echo esc_attr($zoo_cw_attr_class); ?> variations__attribute__value dropdown"
                        ...
                        if ($product_swatch_data_array != '') {
                            ...
                            if ($zoo_cw_attr_display_type != 'default'): ?>
                                ...
                                <?php endforeach; ?>
                                <input id="hidden_<?php echo $attribute_slug?>" name="<?php echo(esc_attr("attribute_" . $attribute_slug)); ?>"
