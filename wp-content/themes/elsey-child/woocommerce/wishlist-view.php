                    ...
                    <div id="yith-wcwl-row-<?php echo esc_attr($item['prod_id']); ?>" data-row-id="<?php echo esc_attr($item['prod_id']); ?>" class="product-list__item wishlist__item item">
						...
						<div class="wishlist__item__details mini-product--group">
							...
							<div class="mini-product__info">
								<p class="mini-product__item mini-product__name heading heading--small"><?php echo apply_filters( 'woocommerce_in_cartproduct_obj_title', $product->get_title(), $product ) ?></p>
								<p class="mini-product__item nanikore"><?php do_action( 'yith_wcwl_table_after_product_name', $item ); ?></p>
						...
						<div class="wishlist__item__extras item-dashboard">
	                        ...
	                        <?php if( $is_user_owner && $repeat_remove_button ): ?>
                                <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove_from_wishlist product-list__item__action cta cta--underlined" title="<?php esc_html_e( 'Remove this product', 'elsey' ) ?>"><?php esc_html_e( 'Remove', 'elsey' ) ?></a>
                            <?php endif; ?>
		...
		<?php
         ...
         ?>
            ...
            <div class="wishlist-empty align--center">
                <h2 class="ja heading--xlarge spacing--normal"><?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', esc_html__( 'No products were added to the wishlist', 'elsey' ) ) ?></h2>
				<p class="wishlist_desc"><?php esc_html_e( 'あなたの気になる商品のハートマークをタップするとリストに追加されます。', 'elsey' ) ?></p>
				<p class="return-to-shop">
		<a class="button wc-backward" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
			<?php esc_html_e( 'Return to shop', 'elsey' ) ?>
		</a>
	</p>
            </div>
        <?php
