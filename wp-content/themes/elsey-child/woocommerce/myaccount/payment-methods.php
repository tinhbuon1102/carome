...
$epsilon_method = show_epsilon_method();

do_action( 'woocommerce_before_account_payment_methods', $has_methods ); ?>
<h1 class="account__heading heading heading--xlarge serif"><?php esc_html_e( 'Credit Card Information', 'elsey' ); ?></h1>
<?php if ( $has_methods ) : ?>
...
<?php elseif (!$epsilon_method) : ?>
	<p class="woocommerce-Message woocommerce-Message--info woocommerce-info"><?php esc_html_e( 'No credit card info found.', 'elsey' ); ?></p>
<?php endif; ?>

<?php echo $epsilon_method?>
