...
<div class="order--checkout__review__section order-shipments">
	<h3 class="heading heading--small"><?php esc_html_e( 'Shipping Address', 'elsey' ); ?></h3>
	<div class="summarybox">
		<div class="readonly-address serif">
			<address class="readonly-address__contents"><?php echo ( $address = $order->get_formatted_shipping_address() ) ? $address : __( 'N/A', 'elsey' ); ?></address>
		</div>
	</div>
</div><!-- /.order-shipments -->
<div class="order--checkout__review__section order-payment-instruments">
	<div class="order-billing">
	<h3 class="heading heading--small"><?php esc_html_e( 'Customer Details', 'elsey' ); ?></h3>
	<div class="readonly-address serif">
