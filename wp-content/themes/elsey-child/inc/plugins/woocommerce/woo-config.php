...
if ( class_exists( 'WooCommerce' ) ) {
  ...
  // Product Listing Pages - Function to return new placeholder image URL
	add_filter( 'woocommerce_placeholder_img_src', 'elsey_custom_shop_placeholder', 1000 );
	function elsey_custom_shop_placeholder( $image_url ) {
	  $image_url = get_stylesheet_directory_uri().'/inc/plugins/woocommerce/images/shop-sample-new.jpg';
	  return $image_url;
	}
  ...
  if (!function_exists('elsey_product_thumb_wrap_open')) {
		function elsey_product_thumb_wrap_open() {
		  ...
		  if ( defined( 'YITH_WCWL' ) ) {
		  	$html .= '<div class="els-product-wishlist test">';
