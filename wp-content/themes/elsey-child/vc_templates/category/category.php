    ...
    function elsey_product_categories_function( $atts, $content = NULL ) {
	    ...
	    <?php
	      ...
	      foreach ($pro_cats as $pro_cat) {
	        ...
	        $output_default .= '<div class="els-catdt-text els-catsc-text"><div class="els-cat-info-box test-ctheme2">';

	        if( $pro_cat->name ) {
	          $output_default .= '<div class="els-catdt-name els-catsc-name">'.esc_attr($pro_cat->name);
