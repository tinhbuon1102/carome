...
$post_status = implode("','", array('wc-on-hold') );
...
if($days>4){	
	echo '<strong style="color: #f00;">Should Update Order status to: wc-unpaid-deadline</strong><br/>';
	//$order->update_status('wc-unpaid-deadline', 'Auto Update Status :'.date('Y-m-d'));
}
else{
