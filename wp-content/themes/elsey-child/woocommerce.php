                                ...
                                <div class="els-shop-filter row">
                                    <?php if ($b) { ?>
                                        <div class="els-result-count col-xs-6 <?php //echo esc_attr($elsey_woo_result_cnt_class);   ?>">
                                            <?php
                                            if (isset($_REQUEST['s']) && isset($_REQUEST['post_type']) && $_REQUEST['post_type'] == 'product') {
                                                $allsearch = new WP_Query("s=" . $_REQUEST['s'] . "&post_type=product");
                                                $count = $allsearch->post_count;
                                                if (!isset($count) || $count <= 0 || $count == null) {
