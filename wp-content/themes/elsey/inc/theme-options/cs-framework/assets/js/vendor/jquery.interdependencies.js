...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Elsey the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is elsed.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to else condition, true show always, false hide always
         *
         */
