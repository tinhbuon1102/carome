...
<div id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
  	...
  	<div class="els-single-product-wrap">   
		...
		<div class="row"> 
    		<div class="els-product-image-col <?php echo esc_attr($product_sticky_image_class); ?>"> 
    	  		<!-- Custom Changes Ends --> 
				<?php
					/**
			...
			<div class="els-product-summary-col <?php echo esc_attr($product_sticky_summary_class); ?>">	
			  <!-- Custom Changes Ends -->
