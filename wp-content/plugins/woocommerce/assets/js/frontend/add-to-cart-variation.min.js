...
;(function ( $, window, document, undefined ) {
	...
	var VariationForm = function( $form ) {
		...
		$form.on( my_event, '.single_add_to_cart_button', { variationForm: this }, this.onAddToCart );
	...
	VariationForm.prototype.onAddToCart = function( event ) {
		if ( $( this ).is('.disabled') ) {
			...
			if (!is_submited)
			{
				form.$form.submit();
				is_submited = true;
				if ($('.woo-quick-view').length)
				{
					form.$form.find('input').attr('disabled', true);
					form.$form.find('select').attr('disabled', true);
					form.$form.find('button').attr('disabled', true);
				}
			}
		}
	};
