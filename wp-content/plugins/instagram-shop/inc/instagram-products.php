...
?>
<script>
var insta_related_products = <?php echo json_encode($insta_related_products);?>;
var ig = {};
var args = {};
...
ig.build = function(data, args) {
	...
	jQuery.each(data.data, function(i, item) {
		...
		var instaID_strip = instaID.replace('https://www.instagram.com/p/', '').replace('/', '');

		if (insta_related_products[instaID_strip] && insta_related_products[instaID_strip]['hide'] && insta_related_products[instaID_strip]['hide'] == 1)
		{
			// Hide in setting
			return true;
		}
