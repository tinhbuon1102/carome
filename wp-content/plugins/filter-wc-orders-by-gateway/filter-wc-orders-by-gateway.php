<?php
/**
 * Plugin Name: Filter WooCommerce Orders by Payment Methods
...
class WC_Filter_Orders_By_Payment {
	...
	public function load_textdomain() {
		$locale = apply_filters( 'plugin_locale', get_locale(), 'wc-filter-orders-by-payment' );
		load_textdomain( 'wc-filter-orders-by-payment', WP_LANG_DIR . '/filter-wc-orders-by-gateway/wc-filter-orders-by-payment-' . $locale . '.mo' );
		load_plugin_textdomain( 'wc-filter-orders-by-payment', false,
