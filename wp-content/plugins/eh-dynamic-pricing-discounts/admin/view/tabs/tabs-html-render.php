...
<script>
    jQuery(function () {
        ...
        jQuery('.payment_method_select').select2();
...
<style>
    ...
    .deletebtn{
        background: url(<?php echo plugins_url('/eh-dynamic-pricing-discounts/img/del.png'); ?>) 10px 10px no-repeat;
        width: 15px;
        height: 15px;
        background-size: 100%;
    ...
    .editbtn{
        background: url(<?php echo plugins_url('/eh-dynamic-pricing-discounts/img/edit.png'); ?>) 10px 10px no-repeat;
        width: 15px;
        height: 15px;
        background-size: 100%;
        background-position: top left;
...
<div class = "wrap" style = "margin: auto;">
    ...
    $execution_order = isset($settings['execution_order']) ? $settings['execution_order'] : array('product_rules',
        'combinational_rules',
    ...
    <h2 class="nav-tab-wrapper">        
        ...
        <a href="?page=dynamic-pricing-main-page&tab=licence" class="nav-tab <?php echo $active_tab == 'licence' ? 'nav-tab-active' : ''; ?>"><?php _e('Licence', 'eh-dynamic-pricing-discounts'); ?></a>
    ...
    <div class="clear"></div>
        ...
        <ul class="subsubsub">
            ...
            foreach ($execution_order as $key => $tabkey) {
                ...
                echo "<li>";
                echo '<a href="?page=dynamic-pricing-main-page&tab=' . $tabkey . '" class="' . $active_class . '" >' . $tab_name . '</a>' . $delimiter;
                echo "</li>";
            }
            ?>
        </ul>
...
<?php
                    if ($active_tab == 'product_rules') {    // product rule tab                        
                        _e("Note - In this section every rule is executed individually for every product. Each product is a distinct entity.", 'eh-dynamic-pricing-discounts');
                    }
...
?>
                ...
                ?>
                    ...
                    if ($active_tab == 'cat_combinational_rules') {
                    ...
                    } elseif ($active_tab == 'BOGO_category_rules') {
                        require('selected-tab-content/BOGO_category_rule-tab.php');
                        ...
                        include( xa_dy_root_path . 'includes/wf_api_manager/html/html-wf-activation-window.php' );
                ...
                <form name="alter_display_form" method="get" action="" style="width:99.7%;">			<!--Displays Table List Of Saved Rules--->
...
<style>
    td.icon-move{
        background-image: url('<?php echo plugins_url('eh-dynamic-pricing-discounts/jquery-ui/drag2.png'); ?>');
