...
if (isset($allrules['combinational_rules'])) {
    ...
    <div style="float: right;padding: 10px;">
        ...
        ?>
        Page: 
        <select style="display: inline-block;" onchange="page_dropdown_func('combinational_rules');" id="page_dropdown">
            <?php
            for($i=1;$i<=$pages;$i++)
            {
                $selected= '';
        ...
        <button type="button" <?php echo $prevdisable;?> class='<?php echo $classprev;?>' onclick="new_page(<?php echo $current_page_no-1;?>,'combinational_rules');"></button>
        <button type="button" <?php echo $nextdisable;?> class='<?php echo $classnext;?>' onclick="new_page(<?php echo $current_page_no+1;?>,'combinational_rules');"></button>
    </div>
