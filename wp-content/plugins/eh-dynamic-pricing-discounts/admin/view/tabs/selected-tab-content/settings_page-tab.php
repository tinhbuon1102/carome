...
$dummy_settings['execution_order'] = array('product_rules',
    ...
    'category_rules',
    'cart_rules',
    'buy_get_free_rules','BOGO_category_rules');
...
}if (!isset($BOGO_category_rules_on_off)) {
...
<form name="post"  method="GET" id="post">
    ...
    <center style="max-width:900px">
        <table class="table"style="font-size: small;margin-left: 20px;" >
            ...
            <tr>
                <td>
                    <select id="disabled_modes"  name="disabled_modes[]"  size="6" style="width: 300px;height:auto;min-height:150px;" >
                        <?php
                ...
                <td>
                    <select id="enabled_modes" name="enabled_modes[]" size="6" style="width: 300px;height:auto;min-height:150px;" multiple>
                        <?php
                        ...
                        <div class="panel-wrap product_data" style="min-height: 220px;">
                            <ul class="product_data_tabs wc-tabs">
                                <li class="general_options   active">
                                    <a class="xa_link" onclick="select(this, '#general_product_data')">
                                        <span>General</span>
                                    </a>
                                </li>
                                <li class="pricing_tabel_option  " style="display: block;">
                                    <a class="xa_link" onclick="select(this, '#pricing_tabel_option')">
                                        <span>Pricing Table</span>
                                    </a>
                                </li>
                                <li class="offers_tabel_option  " style="display: block;">
                                    <a class="xa_link" onclick="select(this, '#offers_tabel_option')">
                                        <span>Offers Table</span>
                                    </a>
                                </li>
                                <li class="bogo_rules_options  " style="display: block;">
                                    <a class="xa_link" onclick="select(this, '#bogo_rules_options')">
                                        <span>BOGO options</span>
                                    </a>
                                </li>
                                <!--                                    <li class="inventory_options  " style="display: block;">
                                                                            <a class="xa_link" onclick="select(this,'#other_options')">
                            ...
                            <div  class="panel woocommerce_options_panel" style="display: block;">
                                ...
                                <div class="options_group" id="offers_tabel_option" style="display: none;">                                        
                                    <p class="form-field  " >
                                        <label for="offer_table_on_off">Display Offers Table on Product Page</label>
                                        ...
                                        <select id="offer_table_on_off" name="offer_table_on_off" class="select short" style="" selected='<?php echo $offer_table_on_off ?>'>
                                            <option value='enable'  <?php echo(($offer_table_on_off == 'enable') ? 'selected' : ''); ?>>Yes</option>
                                            <option value='disable'  <?php echo(($offer_table_on_off == 'disable') ? 'selected' : ''); ?>>No</option>
                                        </select>
                                    </p>
                                    <p class="form-field  " >
                                        <label for="offer_table_position">Position of Offers Table on Product Page</label>
                                        <span class="woocommerce-help-tip" data-tip="Select where you want to show this table on product page" ></span>
                                        <select id="offer_table_position" name="offer_table_position" class="select short" style=""  selected='<?php echo $offer_table_position ?>'>
                                ...
                                <div class="options_group" id="bogo_rules_options" style="display: none;">
                                    <p class="form-field  ">
                                        <label for="auto_add_free_product_on_off">Automatically add free products</label>
