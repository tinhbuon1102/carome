...
/**
 * View for Email edit page Actions block
 */
...
<div class="rp_wcec">
    <div class="rp_wcec_actions">
        <select name="rp_wcec_email_actions">
    ...
    <div class="rp_wcec_actions_footer submitbox">
        ...
        <?php endif; ?>
        <button type="submit" class="button button-primary" title="<?php _e('Submit', 'rp_wcec'); ?>" name="rp_wcec_email_button" value="actions"><?php _e('Submit', 'rp_wcec'); ?></button>
    </div>
