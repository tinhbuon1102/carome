...
//                $this->loader->add_filter( 'woocommerce_cart_item_price', $discount, 'get_cart_item_html', 99, 3 );
                ...
                //add free gift automatically in the cart
                $this->loader->add_action( 'template_redirect', $discount, 'add_free_gifts_to_cart' );
                ...
                $this->loader->add_action( 'woocommerce_before_calculate_totals', $discount, 'decrease_free_gifts_quantities_in_cart' );
                 ...
                 $this->loader->add_filter( 'woocommerce_cart_subtotal', $discount, 'review_minicart_subtotal',90, 3 );
                ...
                //$this->loader->add_filter( 'woocommerce_shipping_package_name', $discount, 'get_shipping_label',10 ,3);
	}
