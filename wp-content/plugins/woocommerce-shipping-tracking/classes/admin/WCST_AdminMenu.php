...
class WCST_AdminMenu
{
	...
	private function render_edit_messages_tab()
	{
		...
		<?php //settings_fields('wcst_template_messages_group'); ?> 
				...
				<p>
					<?php _e('For the <strong>main</strong> shipping company use the <strong>[shipping_company_name]</strong>, <strong>[tracking_number]</strong>, <strong>[custom_text]</strong>, <strong>[dispatch_date]</strong> and <strong>[url_track]</strong> shortocodes to display into the messages the Shipping company name, the tracking number and the tracking url.', 'woocommerce-shipping-tracking');?>
					<br/>
					<?php _e('For <strong>additional</strong> shipping companies use the <strong>[additional_shipping_company_name]</strong>, <strong>[additional_shipping_tracking_number]</strong>, <strong>[additional_custom_text]</strong>, <strong>[additional_dispatch_date]</strong> and <strong>[additional_shipping_url_track]</strong> shortcodes.', 'woocommerce-shipping-tracking');?>
				</p>
				<div id="wcst_description_note">
					<strong><?php _e('NOTE', 'woocommerce-shipping-tracking');?></strong> <br/>
				...
				<h2 class="wcst_section_title" ><?php _e('Email', 'woocommerce-shipping-tracking');?></h2>
					<label><?php _e('Main shipping company message', 'woocommerce-shipping-tracking');?></label>
					...
					<label class="wcst_option_label"><?php _e('Additional companies message (in case of one or more additional shippings. Will be rendered one per additional shippings).', 'woocommerce-shipping-tracking');?></label>
					...
					<label class="wcst_option_label"><?php _e('Active notification: Text showed before tacking info ', 'woocommerce-shipping-tracking');?></label>
					<p><?php _e('This text will be showed before the tracking info messages setted in the previous options. You can use the following shortcodes: <strong>[billing_first_name]</strong>, <strong>[billing_last_name]</strong>, <strong>[shipping_first_name]</strong>, <strong>[shipping_last_name]</strong>, <strong>[formatted_billing_address]</strong>, <strong>[formatted_shipping_address]</strong>.', 'woocommerce-shipping-tracking');?></p>
					...
					<label class="wcst_option_label"><?php _e('Email message preview', 'woocommerce-shipping-tracking');?></label>
					<div class="preview_box"><?php echo nl2br($mail_message)."<br><br>".nl2br($mail_additional_snippet);?></div>
				
					<label class="wcst_option_label"><?php _e('Active notification email message preview', 'woocommerce-shipping-tracking');?></label>
				...
				<h2 class="wcst_section_title"><?php _e('Order details page', 'woocommerce-shipping-tracking');?></h2>				
					...
					<label class="wcst_option_label"><?php _e('Order detail page message preview', 'woocommerce-shipping-tracking');?></label>
	...
	private function render_add_custom_companies_tab()
	{
		...
		<div class="wrap white-box">
			...
			<p><b><?php _e('NOTE:', 'woocommerce-shipping-tracking');?></b>
				<?php _e('You can create a special URL using the <b>%s</b> string in the address as placeholder for the tracking code. For example: <i>"http://www.shipping-company.com/?tacking-code:%s"</i><br/>In this way the WCST plugin will include the tracking code directly in the url.', 'woocommerce-shipping-tracking');?>
			<p>
			<p>
			...
			<form method="post" >
				...
				<?php if($custom_companies && is_array($custom_companies)):
						...
						<div class="input_box" >
							...
							<h3><label class="wcst_label"><?php _e('Extra options', 'woocommerce-shipping-tracking'); ?> </label></h3>
							<label class="wcst_label"><?php _e('Disable the tracking url', 'woocommerce-shipping-tracking'); ?> </label>
	...
	private function render_general_tab()
	{
		...
		<div class="wrap white-box">
			...
			<p><?php _e('Enable the ones that will be used to ship products.', 'woocommerce-shipping-tracking');?></p>
				...
				<p><?php _e('This will be the company that will be already selected when editing an order.', 'woocommerce-shipping-tracking');?></p>
	...
	public function render_delivery_date_time_tab()
	{
		...
		<div class="wrap white-box">
		<h2><?php _e('Delivery date and time input fields options', 'woocommerce-customers-manager');?></h2>
		<?php if($wpml->is_wpml_active()):?>
			<small class="wcst_notice"><strong><?php _e('NOTE:', 'woocommerce-customers-manager');?></strong> <?php _e('WPML Detected! to translate following texts simply select the language you desire from the upper WPML language selector, edit texts and save!', 'woocommerce-customers-manager');?> </small>
		<?php endif; ?>
			...
			<?php //screen_icon("options-general"); ?>
			<form method="post" >
				<h2 class="wcst_section_title"><?php _e('Visibility', 'woocommerce-shipping-tracking');?></h2>
	...
	public function render_general_options_tab()
	{
		...
		<div class="wrap white-box">
			...
			<?php settings_fields('wcst_general_options_group'); ?> 
				...
				<h2  class="wcst_section_title"><?php _e('System', 'woocommerce-shipping-tracking');?></h2>
				...
				<h3 class="wcsts_option_section_title"><?php _e('Tacking info positioning', 'woocommerce-shipping-tracking');?></h3>
				...
				<label class="wcst_option_label"><?php _e('Show estimated date warning text for item no longer in stock ', 'woocommerce-shipping-tracking'); ?></label>
				<p><?php _e('to customize the showed text, use the <i>Text displayed when the product is out of stock</i> setting in the next section', 'woocommerce-shipping-tracking') ?></p>
				...
				<label class="wcst_option_label" ><?php _e('Label to display before the date:', 'woocommerce-shipping-tracking'); ?></label>
				<p>
				...
				<label class="wcst_option_label" ><?php _e('Text displayed when the product is out of stock:', 'woocommerce-shipping-tracking'); ?></label>
				...
				<label class="wcst_option_label" ><?php _e('Text displayed inside the button', 'woocommerce-shipping-tracking'); ?></label>
				<p>
				...
				<label class="wcst_option_label" ><?php _e('Active notification email subject', 'woocommerce-shipping-tracking'); ?></label>
				<p>
				<?php _e('This is the subject used for active notification emails (the ones sent by checking the "Send a notification email" in the order details page).', 'woocommerce-shipping-tracking'); ?>
				</p>
