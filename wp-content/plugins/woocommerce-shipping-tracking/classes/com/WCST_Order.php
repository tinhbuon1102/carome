...
class WCST_Order
{
	var $tracking_key_array = array('_wcst_order_trackno','_wcst_order_dispatch_date','_wcst_custom_text','_wcst_order_trackname','_wcst_order_trackurl','_wcst_order_track_http_url','_wcst_order_disable_email');
	...
	public function save_shippings_info_metas($post_id, $data_to_save, $merge = false)
	{
		...
		if(isset($data_to_save['wcst_send_shipping_notification_email']))
		{
			...
			$wcst_email_model->send_active_notification_email_with_tracking_codes($this->get_billing_email($order), $message, $active_notification_email_subject);
		}
