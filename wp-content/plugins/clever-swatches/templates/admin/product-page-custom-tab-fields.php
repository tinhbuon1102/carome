				...
				<div class="zoo-cw-collapse">
					<table class="zoo-cw-label-data">
						<tr>
							...
							<td><input type="text" value="<?php echo $labelValue; ?>" name="zoo_cw_label_<?php echo  $attribute_slug; ?>"></td>
						</tr>
						...
						<?php $tmp_options_data_array = isset($product_swatch_data_array[$attribute_slug]['options_data']) ? $product_swatch_data_array[$attribute_slug]['options_data'] : array();?>
							<?php if ( is_array( $options ) ) { ?>
								<?php if ( taxonomy_exists(  $attribute_slug ) ) { ?>
									<?php $terms = get_terms( $attribute_slug, array('menu_order' => 'ASC') ); pr($attribute_slug);?>
											...
											<div class="zoo-cw-sub-collapse">
												<table class="zoo-cw-attr-option">
													...
													<tr class="zoo-cw-sci" <?php if($display_type != 'image'): echo 'style="display:none;"'; endif;?>>
														...
														<td><img height="30px" width="30px" src="<?php echo $image;?>" alt="<?php _e('Select Image','clever-swatches');?>" class="zoo-cw-scimage_<?php echo  $term->slug; ?>">
															...
															<button type="button" data-attrname="<?php echo  $term->slug; ?>" class="zoo-cw-scimage-upload"><?php _e('Browse','clever-swatches')?></button>
														</td>
													</tr>
										...
										<div class="zoo-cw-sub-collapse">
											<table class="zoo-cw-attr-option">
												...
												<tr class="zoo-cw-sci" <?php if($display_type != 'image'){echo 'style="display: none"';}?>>
													<td><?php _e('Select/Upload Image','clever-swatches')?></td>
													<td><img height="30px" width="30px" src="<?php echo($image);?>" alt="<?php _e('Select Image','clever-swatches');?>" class="zoo-cw-scimage_<?php echo  $option; ?>">
														<input type="hidden" value="<?php echo($image);?>" class="zoo-cw-input-scimg-<?php echo  $option; ?>" name="zoo-cw-input-scimg-<?php echo  $option; ?>">
														<button type="button" data-attrname="<?php echo  $option; ?>" class="zoo-cw-scimage-upload"><?php _e('Browse','clever-swatches')?></button>
													</td>
												</tr>
