...
if ( WooCommerce_Waitlist_Plugin::persistent_waitlists_are_disabled( $product_id ) )
	echo __("\n\nYou have now been removed from the waitlist for this product.", 'woocommerce-waitlist');
