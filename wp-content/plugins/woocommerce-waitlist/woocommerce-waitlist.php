...
/*
   ...
   Plugin URI: http://www.woothemes.com/products/woocommerce-waitlist1/
...
// Define WCWL_PLUGIN_FILE.
if ( ! defined( 'WCWL_PLUGIN_FILE' ) ) {
...
if ( ! class_exists( 'WooCommerce_Waitlist_Plugin' ) ) {
	...
	class WooCommerce_Waitlist_Plugin {
		 ...
		 * @var object
		 */
		public static $Pie_WCWL_Frontend_Init;
		/**
		 ...
		 * @return void
		 */
		public function wcwl_woocommerce_version_notice() {
			?>
			<div class="error">
		...
		public function load_classes() {
			...
			if ( is_admin() ) {
				require_once 'classes/admin/class-pie-wcwl-custom-admin-tab.php';
				require_once 'classes/admin/class-pie-wcwl-admin-ui.php';
				self::$Pie_WCWL_Admin_UI = new Pie_WCWL_Admin_UI();
				require_once 'classes/admin/class-pie-wcwl-waitlist-settings.php';
				require_once 'classes/admin/class-pie-wcwl-waitlist-archive.php';
			} else {
				require_once 'classes/frontend/class-pie-wcwl-frontend-init.php';
				self::$Pie_WCWL_Frontend_Init = new Pie_WCWL_Frontend_Init();
			}
		}
		...
		public static function localization() {
			load_plugin_textdomain( 'woocommerce-waitlist', false, Pie_WCWL_Compatibility::plugin_url() . '/assets/languages/' );
		}
			...
			if ( WCWL_AUTO_WAITLIST_CREATION ) {
				...
				foreach ( $products as $product_id ) {
					if ( ! is_array( get_post_meta( $product_id, WCWL_SLUG, true ) ) ) {
						...
						update_post_meta( $product_id, '_' . WCWL_SLUG . '_count', 0 );
					}
				}
			}
		}
