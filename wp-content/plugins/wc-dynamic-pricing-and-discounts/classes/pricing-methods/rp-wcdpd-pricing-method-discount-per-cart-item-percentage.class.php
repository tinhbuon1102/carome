 ...
 * @author RightPress
 */
if (!class_exists('RP_WCDPD_Pricing_Method_Discount_Per_Cart_Item_Percentage')) {
...
class RP_WCDPD_Pricing_Method_Discount_Per_Cart_Item_Percentage extends RP_WCDPD_Pricing_Method_Discount_Per_Cart_Item
{
    ...
    {
        return __('Percentage discount per item', 'rp_wcdpd');
    }
    ...
    public function calculate($setting, $amount = 0, $adjustment = null)
    {
        ...
        $subtotal = RP_WCDPD_Conditions::get_sum_of_cart_item_subtotals_by_product_conditions($conditions, $include_tax);
