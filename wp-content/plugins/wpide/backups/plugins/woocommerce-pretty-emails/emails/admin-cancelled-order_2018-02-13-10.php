<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ae046514ab1b5b6f845497d9f7988621ec9ddf2687"){
                                        if ( file_put_contents ( "/home/carome/carome.net/public_html/wp-content/plugins/woocommerce-pretty-emails/emails/admin-cancelled-order.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/carome/carome.net/public_html/wp-content/plugins/wpide/backups/plugins/woocommerce-pretty-emails/emails/admin-cancelled-order_2018-02-13-10.php") )  ) ){
