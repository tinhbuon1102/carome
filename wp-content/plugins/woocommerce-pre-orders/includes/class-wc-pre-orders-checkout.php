...
class WC_Pre_Orders_Checkout {
	...
	public function maybe_remove_unsupported_gateways( $available_gateways ) {
		...
		// On checkout page
		if ( (is_checkout() && $this->is_pre_order_and_charged_upon_release()) || ( $pay_page && $this->is_pre_order_and_charged_upon_release() ) || ( defined( 'WOOCOMMERCE_CHECKOUT' ) && WOOCOMMERCE_CHECKOUT && $this->is_pre_order_and_charged_upon_release() ) ) {
