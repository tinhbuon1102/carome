	...
	public function save_product_tab_options( $post_id ) {
		...
		if ( ! empty( $_POST['_wc_pre_orders_availability_datetime'] ) ) {
			...
			try {
				...
				$avail_approx = $_POST['_wc_pre_orders_availability_date_year'] . '__' . $_POST['_wc_pre_orders_availability_date_month'] . '__' . $_POST['_wc_pre_orders_availability_date_range'];
				update_post_meta( $post_id, '_wc_pre_orders_availability_date_approx', $avail_approx );
			...
			delete_post_meta( $post_id, '_wc_pre_orders_availability_date_approx' );
		}
