...
if (isset($_POST['search_replace_email_domain']) && $_POST['search_replace_email_domain']) {
...
$fixpartials = (isset($_POST['fixpartials']) && $_POST['fixpartials']) ? $_POST['fixpartials'] : false;
$report = DUPX_UpdateEngine::load($dbh, $GLOBALS['REPLACE_LIST'], $_POST['tables'], $_POST['fullsearch'], $fixpartials);

if(isset($_POST['fixpartials']) && $_POST['fixpartials']){
