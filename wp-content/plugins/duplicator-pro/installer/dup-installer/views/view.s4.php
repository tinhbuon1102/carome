...
$admin_redirect = (($GLOBALS['DUPX_AC']->mu_mode > 0) && ($subsite_id == -1))
	? "{$url_new }/wp-admin/network/admin.php?page=duplicator-pro-tools&tab=d"
	: "{$url_new }/wp-admin/admin.php?page=duplicator-pro-tools&tab=d";
...
$admin_login	= "{$url_new }/{$admin_base}{$admin_url_qry}redirect_to={$admin_redirect}";
