...
$GLOBALS['DUPX_ROOT']     = str_replace("\\", '/', (realpath(dirname(dirname(dirname(__FILE__))))));
$GLOBALS['DUPX_ROOT_URL'] = rtrim("http".(!empty($_SERVER['HTTPS']) ? "s" : "")."://".$_SERVER['SERVER_NAME'].dirname(dirname(dirname($_SERVER['PHP_SELF']))), '/');
