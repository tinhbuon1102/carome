...
class DUPX_Constants
{
    ...
    public static function init()
    {
        ...
        $GLOBALS['SQL_FILE_NAME'] = "dup-installer-data__".DUPX_Package::getPackageHash().".sql";
    ...
    public static function initErrDefines()
    {
        ...
        define('ERR_MAKELOG', 'PHP is having issues writing to the log file <b>'.$GLOBALS['DUPX_INIT'].'\dup-installer-log__'.DUPX_Package::getPackageHash().'.txt .</b> In order for the Duplicator to proceed to validate your owner/group and permission settings for PHP on this path. Try temporarily setting you permissions to 777 to see if the issue gets resolved.  If you are on a shared hosting environment please contact your hosting company and tell them you are getting errors writing files to the path above when using PHP.');
