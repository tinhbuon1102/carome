...
class DUP_PRO_Server 
{
    ...
    public static function getInstallerFiles() {
        ...
        return array(
            ...
            DUPLICATOR_PRO_ORIG_FOLDER_PREFIX . '[HASH]' . DUP_PRO_U::__('(directory)') => DUPLICATOR_PRO_WPROOTPATH . DUPLICATOR_PRO_ORIG_FOLDER_PREFIX . DUPLICATOR_PRO_INSTALLER_HASH_PATTERN,
