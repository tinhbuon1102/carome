...
class DUP_PRO_Installer
{
    ...
    private function getWpInfo()
    {
        ...
        $this->addDefineIfExists($wpInfo->configs->defines, 'DUPLICATOR_PRO_WPROOTPATH');
        ...
        $wpInfo->configs->realValues->uploadDirsPath = $updDirs['basedir'];
        $wpInfo->configs->realValues->uploadDirsUrl  = $updDirs['baseurl'];
