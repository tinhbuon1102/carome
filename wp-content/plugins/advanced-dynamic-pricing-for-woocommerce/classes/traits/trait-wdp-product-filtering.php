...
trait WDP_Product_Filtering {
	...
	protected function check_product_suitability( $product_id, $operation_type, $operation_values, $operation_method, $cart_item = array() ) {
		...
		} elseif ( in_array( $operation_type, array_keys( WDP_Helpers::get_custom_product_taxonomies() ) ) ) {
			return $this->compare_product_with_custom_taxonomy( $product_id, $operation_values, $operation_method, $operation_type );
		}
	...
	protected function compare_product_with_custom_taxonomy( $product_id, $operation_values, $operation_method, $taxonomy ) {
