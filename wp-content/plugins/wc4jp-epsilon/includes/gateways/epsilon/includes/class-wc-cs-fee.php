...
if( !class_exists( 'WooCommerce_Epsilon_CS_Fee' ) ) :
class WooCommerce_Epsilon_CS_Fee {
    /**
     * @var string
     */
    public $version;
    ...
    public function __construct() {
        ...
        if( is_admin() ) {
			if(isset($_GET['section']) and $_GET['section']=='wc_gateway_epsilon_pro_cs'){
    ...
    public function manage_form_fields() {
        ...
        $current_gateway    = 'epsilon_pro_cs';
        $charge_amount      = 0;
        $max_cart_value     = 0;
    ...
    public function manage_form_fields_for_basic_gateways( $current_gateway ) {
        ...
        ob_start() ?>
        <h3><?php _e( 'Extra charge for Convenience store method', 'wc4jp-epsilon' ) ?></h3>
        <table class="form-table">
            <tbody>
                <tr valign="top">
                    <th scope="row" class="titledesc"><label for="woocommerce_epsilon_pro_cs_extra_charge_name"><?php _e( 'Fee name', 'wc4jp-epsilon' ) ?></label></th>
                    <td class="forminp">
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e( 'Fee name', 'wc4jp-epsilon' ) ?></span></legend>
                            <input class="input-text regular-input " type="text" name="woocommerce_epsilon_pro_cs_extra_charge_name" id="woocommerce_epsilon_pro_cs_extra_charge_name" value="<?php echo $fee_name ?>" placeholder="<?php _e( 'Convenience store Payment method fee', 'wc4jp-epsilon' ) ?>">
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row" class="titledesc"><label for="woocommerce_epsilon_pro_cs_extra_charge_amount"><?php _e( 'Extra charge amount', 'wc4jp-epsilon' ) ?></label></th>
                    <td class="forminp">
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e( 'Extra charge amount', 'wc4jp-epsilon' ) ?></span></legend>
                            <input class="input-text regular-input " type="number" name="woocommerce_epsilon_pro_cs_extra_charge_amount" id="woocommerce_epsilon_pro_cs_extra_charge_amount" style="width:70px" value="<?php echo $charge_amount ?>" placeholder="0" min="0" step="1">
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row" class="titledesc"><label for="woocommerce_epsilon_pro_cs_extra_charge_max_cart_value"><?php _e( 'Maximum cart value to which adding fee', 'wc4jp-epsilon' ) ?></label></th>
                    <td class="forminp">
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e( 'Maximum cart value for adding fee', 'wc4jp-epsilon' ) ?></span></legend>
                            <input class="input-text regular-input " type="number" name="woocommerce_epsilon_pro_cs_extra_charge_max_cart_value" id="woocommerce_epsilon_pro_cs_extra_charge_max_cart_value" style="width:70px" value="<?php echo $max_cart_value ?>" placeholder="0" min="0" step="1">
                            <p><?php _e( 'If you dont need this setting, please set empty, 0.', 'wc4jp-epsilon' ) ?></p>
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row" class="titledesc"><?php _e( 'Includes taxes', 'wc4jp-epsilon' ) ?></th>
                    <td class="forminp">
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e( 'Calculate taxes on this fee', 'wc4jp-epsilon' ) ?></span></legend>
                            <select name="woocommerce_epsilon_pro_cs_extra_charge_calc_taxes" id="woocommerce_epsilon_pro_cs_extra_charge_calc_taxes" style="" class="select">
                                <option value="no-tax" <?php selected( 'no-tax', $calc_taxes ) ?>><?php _e( 'Do not calculate taxes', 'wc4jp-epsilon' ) ?></option>
                                <option value="tax-incl" <?php selected( 'tax-incl', $calc_taxes ) ?>><?php _e( 'The fee is taxes included', 'wc4jp-epsilon' ) ?></option>
                                <option value="tax-excl" <?php selected( 'tax-excl', $calc_taxes ) ?>><?php _e( 'The fee is taxes excluded', 'wc4jp-epsilon' ) ?></option>
                            </select>
                        </fieldset>
                    </td>
                </tr>
