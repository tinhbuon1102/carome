...
echo '<small class="description">Above is your bypass URL, copy and it\'s best to test in a Chrome incognito window or a separate browser to simulate an anonymous visitor.</small><br><small>Need to display your bypass url on the page or have visitors enter it as a password? <a target="_blank" href="http://support.seedprod.com/article/146-bypass-url-shortcodes">Learn More</a></small>';
echo '
<script>
