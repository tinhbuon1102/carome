...
function seed_cspv5_section_aweber($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_aweber_lists(){
    ...
    $lists = array();
            ...
            require_once SEED_CSPV5_PLUGIN_PATH.'extentions/aweber/aweber_api/aweber_api.php';
            ...
            if(empty($seed_cspv5_aweber_auth) && !empty($authorization_code)){
                try {
                    ...
                    update_option('seed_cspv5_aweber_auth_'.$page_id, array('consumer_key'=>$consumerKey,'consumer_secret'=>$consumerSecret,'access_key'=>$accessKey,'access_secret'=>$accessSecret));
                    //echo '200';
                }
 ...
 *  Subscribe Aweber
 */
add_action('seed_cspv5_emaillist_aweber', 'seed_cspv5_emaillist_aweber_add_subscriber');

function seed_cspv5_emaillist_aweber_add_subscriber($args){
