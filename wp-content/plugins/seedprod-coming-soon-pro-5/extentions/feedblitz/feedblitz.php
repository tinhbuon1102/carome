...
function seed_cspv5_section_feedblitz($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_feedblitz_lists(){
 ...
 *  Subscribe Feedblitz
 */
add_action('seed_cspv5_emaillist_feedblitz', 'seed_cspv5_emaillist_feedblitz_add_subscriber');

function seed_cspv5_emaillist_feedblitz_add_subscriber($args){
