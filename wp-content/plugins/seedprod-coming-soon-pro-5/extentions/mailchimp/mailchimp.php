...
function seed_cspv5_section_mailchimp($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_mailchimp_lists(){
    $mailchimp_api_key = $_REQUEST['mailchimp_api_key'];
    $page_id = $_REQUEST['page_id'];
    $emaillist = $_REQUEST['emaillist'];
    $lists = array();
    try{
        require_once SEED_CSPV5_PLUGIN_PATH.'extentions/mailchimp/seed_cspv5_MCAPI.class.php';
 ...
 *  Subscribe MailChimp
 */
add_action('seed_cspv5_emaillist_mailchimp', 'seed_cspv5_emaillist_mailchimp_add_subscriber');

function seed_cspv5_emaillist_mailchimp_add_subscriber($args){
