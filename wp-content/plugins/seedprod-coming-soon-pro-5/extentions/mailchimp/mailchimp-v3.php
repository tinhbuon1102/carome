...
function seed_cspv5_section_mailchimp_v3($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_mailchimp_v3_lists(){
 ...
 *  Subscribe MailChimp
 */
add_action('seed_cspv5_emaillist_mailchimp_v3', 'seed_cspv5_emaillist_mailchimp_add_subscriber_v3');

function seed_cspv5_emaillist_mailchimp_add_subscriber_v3($args){
        ...
        if(!empty($enable_reflink) || !empty( $display_optin_confirm )){
            seed_cspv5_emaillist_database_add_subscriber($args);
                ...
                if($update_existing){
                    ...
                    $response = wp_remote_post( $mailchimp_api_url, array(
                        'method'      => 'PUT',
...
function seed_cspv5_get_mailchimp_merge_fields_v3($api_key,$list_id, $settings){
...
function seed_cspv5_get_mailchimp_interest_groups_v3($api_key,$list_id, $settings){
