...
function seed_cspv5_section_constantcontact($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Configure saving subscribers to Constant Contact options. Save after you enter your username and password to load your list. <a href="http://support.seedprod.com/article/35-collecting-emails-with-constant-contact" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/35-collecting-emails-with-constant-contact" target="_blank">Learn how to Configure</a></p>
 ...
 */
function seed_cspv5_get_constantcontact_lists(){
    ...
    $lists = array();
            ...
            if (class_exists('cc')) {
                ...
                require_once SEED_CSPV5_PLUGIN_PATH.'extentions/constantcontact/seed_cspv5_class.cc.php';
            }
 ...
 */
add_action('seed_cspv5_emaillist_constantcontact', 'seed_cspv5_emaillist_constantcontact_add_subscriber');

function seed_cspv5_emaillist_constantcontact_add_subscriber($args){
