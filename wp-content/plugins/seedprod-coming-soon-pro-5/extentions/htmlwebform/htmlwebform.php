...
function seed_cspv5_section_htmlwebform($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Enter a HTML web form from any provider. This will bypass the Thank You page. <a href="http://support.seedprod.com/article/79-use-any-3rd-party-script-or-web-form" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/79-use-any-3rd-party-script-or-web-form" target="_blank">Learn how to Configure</a></p>
