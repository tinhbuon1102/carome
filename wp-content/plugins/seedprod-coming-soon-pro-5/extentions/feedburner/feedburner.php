...
function seed_cspv5_section_feedburner($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <p><a href="http://support.seedprod.com/article/72-feedburner" target="_blank">Learn how to Configure</a></p>
