...
function seed_cspv5_section_campaignmonitor($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_campaignmonitor_lists($apikey = null){
    ...
    $lists = array();
            ...
            if (class_exists('CS_REST_Clients') ) {
                ...
                require_once SEED_CSPV5_PLUGIN_PATH.'extentions/campaignmonitor/campaign_monitor/csrest_clients.php';
            }
     ...
     */
    function cspv5_get_campaignmonitor_clients($apikey=null){
        global $seed_cspv5;
        extract($seed_cspv5);
        $o = $seed_cspv5;
        $clients = array();
        ...
        if(empty($clients)){
            ...
            if (class_exists('CS_REST_General') ) {
                ...
                require_once SEED_CSPV5_PLUGIN_PATH.'extentions/campaignmonitor/campaign_monitor/csrest_general.php';
            }
 ...
 */
add_action('seed_cspv5_emaillist_campaignmonitor', 'seed_cspv5_emaillist_campaignmonitor_add_subscriber');

function seed_cspv5_emaillist_campaignmonitor_add_subscriber($args){
        ...
        require_once( SEED_CSPV5_PLUGIN_PATH.'lib/nameparse.php' );
                if (class_exists('CS_REST_Subscribers') ) {
                    ...
                    require_once SEED_CSPV5_PLUGIN_PATH.'extentions/campaignmonitor/campaign_monitor/csrest_subscribers.php';
                }
