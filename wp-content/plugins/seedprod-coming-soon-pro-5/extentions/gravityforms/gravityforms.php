...
add_filter('seed_cspv5_enable_wp_head_footer_list','seed_cspv5_enable_wp_head_footer_gravityforms');

function seed_cspv5_enable_wp_head_footer_gravityforms($arr){
  $arr[] = 'gravityforms';
  return $arr;
}

function seed_cspv5_section_gravityforms($emaillist,$page_id) {
    // Get settings
...
function seed_cspv5_get_gravityforms_forms(){
...
function seed_cspv5_after_gravity_subscribed_record_record_into_cspv5($entry, $form) {
