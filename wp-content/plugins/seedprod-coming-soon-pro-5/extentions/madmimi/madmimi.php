...
function seed_cspv5_section_madmimi($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Configure saving subscribers to Mad Mimi options. Save after you enter your api key and username to load your list. <a href="http://support.seedprod.com/article/75-collecting-emails-with-mad-mimi" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/75-collecting-emails-with-mad-mimi" target="_blank">Learn how to Configure</a></p>
 ...
 */
function seed_cspv5_get_madmimi_lists(){
    ...
    $lists = array();
            ...
            require_once SEED_CSPV5_PLUGIN_PATH.'extentions/madmimi/seed_cspv5_MadMimi.class.php';
 ...
 *  Subscribe MadMimi
 */
add_action('seed_cspv5_emaillist_madmimi', 'seed_cspv5_emaillist_madmimi_add_subscriber');

function seed_cspv5_emaillist_madmimi_add_subscriber($args){
