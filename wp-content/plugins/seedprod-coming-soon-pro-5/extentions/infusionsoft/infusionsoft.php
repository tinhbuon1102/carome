...
function seed_cspv5_section_infusionsoft( $emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Configure saving subscribers to InfusionSoft options. <a href="http://support.seedprod.com/article/74-collecting-emails-with-infusionsoft" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/74-collecting-emails-with-infusionsoft" target="_blank">Learn how to Configure</a></p>
 ...
 */
add_action('seed_cspv5_emaillist_infusionsoft', 'seed_cspv5_emaillist_infusionsoft_add_subscriber');

function seed_cspv5_emaillist_infusionsoft_add_subscriber($args){
    ...
    if(!class_exists('xmlrpc_client')){
        require_once SEED_CSPV5_PLUGIN_PATH.'extentions/infusionsoft/xmlrpc-2.0/lib/xmlrpc.inc';
    }
