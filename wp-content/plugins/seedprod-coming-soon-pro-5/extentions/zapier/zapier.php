...
function seed_cspv5_section_zapier($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <p><a href="http://support.seedprod.com/article/131-zapier-integration" target="_blank">Learn how to Configure</a></p>
 ...
 *  Subscribe Zapier
 */
add_action('seed_cspv5_emaillist_zapier', 'seed_cspv5_emaillist_zapier_add_subscriber');

function seed_cspv5_emaillist_zapier_add_subscriber($args){
    ...
    // Make Request
    $args = array('timeout' => 45,'body' => $data);
    if(!empty($zapier_url)){
