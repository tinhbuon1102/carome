...
function seed_cspv5_section_activecampaign($emaillist,$page_id) {
    // Get settings
...
?>
    <div class="postbox">
        ...
        <div class="inside">
        <p><?php __('Configure saving subscribers to Get Response options. Save after you enter your api key to load your list. <a href="http://support.seedprod.com/article/118-collecting-emails-with-activecampaign" target="_blank">Learn More</a>', 'seedprod') ?></p>
        ...
        <p><a href="http://support.seedprod.com/article/118-collecting-emails-with-activecampaign" target="_blank">Learn How To Configure</a></p>
 ...
 */
function seed_cspv5_get_activecampaign_lists(){
 ...
 */
add_action('seed_cspv5_emaillist_activecampaign', 'seed_cspv5_emaillist_activecampaign_add_subscriber');

function seed_cspv5_emaillist_activecampaign_add_subscriber($args){
