...
function seed_cspv5_section_convertkit($emaillist,$page_id) {
    // Get settings
 ...
 */
function seed_cspv5_get_convertkit_lists(){
    ...
    $r = array('lists'=>$lists,'forms'=>$forms);
 ...
 */
add_action('seed_cspv5_emaillist_convertkit', 'seed_cspv5_emaillist_convertkit_add_subscriber');

function seed_cspv5_emaillist_convertkit_add_subscriber($args){
        ...
        require_once SEED_CSPV5_PLUGIN_PATH.'extentions/convertkit/seed_cspv5_convertkit.class.php';
